<%@ Page Title="Nuevo Proveedor" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="nuevo_tbl_proveedor.aspx.cs" Inherits="Monolito_4am_DB.Mantenimiento.nuevo_tbl_proveedor" %>
        ...
        <div class="card card-custom">
            <div class="card-body p-4 p-md-5">
                ...
                <h4 class="font-weight-bold text-dark mb-4 text-center">
                    <i class="fa-solid fa-truck-field text-primary mr-2"></i> 
                    <asp:Label ID="lblTitulo" runat="server" Text="Nuevo Proveedor"></asp:Label>
                </h4>

                <div class="form-group mb-4">
                    <label class="font-weight-bold text-secondary mb-2">Nombre del Proveedor <span class="text-danger">*</span></label>
                    <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control form-control-custom" Placeholder="Ej: Importadora Global S.A."></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvNombre" runat="server" ControlToValidate="txtNombre" 
                        ErrorMessage="El nombre del proveedor es obligatorio" CssClass="text-danger small mt-1 d-block" Display="Dynamic"></asp:RequiredFieldValidator>
                </div>

                <div class="d-flex justify-content-between mt-5">
                    <a href="listar_tbl_proveedor.aspx" class="btn btn-light btn-custom text-secondary border">
                    ...
                    <asp:LinkButton ID="btnGuardar" runat="server" CssClass="btn btn-primary btn-custom shadow-sm" OnClick="btnGuardar_Click" OnClientClick="return validarFormulario();">
                        <i class="fa-solid fa-save mr-1"></i> Guardar Proveedor
                    </asp:LinkButton>
                </div>
            </div>
        </div>
